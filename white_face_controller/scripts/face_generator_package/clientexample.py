...
class FaceSelectorNode:
    ...
    def __init__(self):
        ...
        rospy.Subscriber("/my_topic", String, self.example)
    ...
    # H = "happy"
                ...
                #/my_topic Sub
                self.speech_durations, self.play_time, self.play_result = deque([1, 2, 3, 4, 5]), 0, True
                if "iamhappy" in msg.data:
                    global name
                    name = 'happy'
                    level = 1
                elif "iamsad" in msg.data:
                    global name
                    name = 'sad'
                    level = 1
                elif "iamangry" in msg.data:
                    global name
                    name = 'angry'
                    level = 1
                elif "iamsurprised" in msg.data:
                    global name
                    name = 'surprise'
                    level = 1
                else:
